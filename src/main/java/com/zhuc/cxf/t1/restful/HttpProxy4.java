...
public class HttpProxy4 {
	...
	public String accessGet(String uri) throws IOException {
		String result = null;
	...
	public String accessPost(String uri, Object obj) throws IllegalAccessException,
			InvocationTargetException, NoSuchMethodException, IOException {
		return accessPost(uri, getParamsFromObject(obj));
	}

	public String accessPost(String uri, Map<String, String> map) throws IOException {
		return accessPost(uri, getParamsFromMap(map));
	}

	private String accessPost(String uri, List<NameValuePair> nvps) throws IOException {
		String result = null;
